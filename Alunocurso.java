...
public class Alunocurso{
	...
	private void initialize() {
		...
		frmCronograma.setTitle("Alunocurso");
		...
		JLabel lblIDdsciplina = new JLabel("Data curso: ");
		...
		btnincluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				  ...
				  StringSQL = "INSERT INTO aluno (id_professor, id_turma, id_disciplina) "
				  		+ "VALUES + (";StringSQL = StringSQL +
				  		"'"+txtFldidprofessor.getText() + "'" + " , " +
				  		"'" + txtFldidturma.getText() + "'" + " , " +
				  		"'" + txtFldisciplina.getText() + "'";
			} 
		});
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID curso", "NM matricula", "Data curso"
			}
		));
